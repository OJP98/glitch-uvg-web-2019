    ...
    return (
      <div style={divStyle}>
        <form style={formStyle}>
          ...
          {input !== '' ? (
            <div style={divS}>
              <button type="button" label="button" value="X" className="fa fa-times" style={input2Style} onClick={this.clearText} />
              <button type="button" label="button" className="fa fa-search" style={inputSearch} onClick={this.search} />
            </div>
          ) : <button type="button" label="button" className="fa fa-search hover" />}
        </form>
      </div>
    );
  }
